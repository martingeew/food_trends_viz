...
aus_ramen_df = pd.read_csv(
    "../../data/raw/aus_ramen.csv", parse_dates=[0], index_col=[0], skiprows=1
)
germany_ramen_df = pd.read_csv(
    "../../data/raw/germany_ramen.csv", parse_dates=[0], index_col=[0], skiprows=1
)
nth_ramen_df = pd.read_csv(
    "../../data/raw/nth_ramen.csv", parse_dates=[0], index_col=[0], skiprows=1
)
nz_ramen_df = pd.read_csv(
    "../../data/raw/nz_ramen.csv", parse_dates=[0], index_col=[0], skiprows=1
)
uk_ramen_df = pd.read_csv(
    "../../data/raw/uk_ramen.csv", parse_dates=[0], index_col=[0], skiprows=1
)
us_ramen_df = pd.read_csv(
    "../../data/raw/US_ramen.csv", parse_dates=[0], index_col=[0], skiprows=1
)
